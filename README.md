...
<center><img src="docs/images/ipfs_toolbar_popup.png" width="200px" /></center>
...
By installing the Desktop version it will already start the daemon, so running `ipfs daemon` is not necessary.
...
<center><img src="docs/images/ipfs_local.png" width="600px" /></center>
...
<center><img src="docs/images/ipfs_desktop_overview.png" alt="ipfs_desktop_overview" width="750px" /></center>
...
<center><img src="docs/images/ipfs_desktop_detail.png" alt="ifps_desktop_detail" width="750px" /></center>
...
<center><img src="docs/images/ipfs_local_ipfs.png" alt="ipfs_local_ipfs" width="600px" /></center>
...
<center><img src="docs/images/ipfs_local_ipns.png" alt="ipfs_local_ipns" width="600px" /></center>
...
<center><img src="docs/images/ipfs_cloudflare_cname.png" alt="ipfs_cloudflare_cname" width="600px" /></center>

DNS link:

<center><img src="docs/images/ipfs_cloufdflare_txt.png" alt="ipfs_cloufdflare_txt" width="600px" /></center>
...
<center><img src="docs/images/ipfs_cloudflare_ca.png" alt="ipfs_cloudflare_ca" width="400px" /></center>

After a few seconds this should complete:

<center><img src="docs/images/ipfs_cloudflare_ca_done.png" alt="ipfs_cloudflare_ca_done" width="400px" /></center>
...
<center><img src="docs/images/ipfs_cloudflare_wait.png" alt="ipfs_cloudflare_wait" width="600px" /></center>

After waiting a couple of minutes the image shows too:

<center><img src="docs/images/ipfs_cloudflare_done.png" alt="ipfs_cloudflare_done" width="600px" /></center>
...
<center><img src="docs/images/ipfs_ens_overview.png" alt="ipfs_ens_overview" width="750px" /></center>

Note: Adding content to the network will cost gas! 

<center><img src="docs/images/ipfs_gas_cost.png" alt="ipfs_gas_cost" width="300px" /></center>
...
<center><img src="docs/images/ipfs_eth_link.png" alt="ipfs_eth_link" width="600px" /></center>
